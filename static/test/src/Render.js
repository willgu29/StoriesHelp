...
//Frame by frame
function draw(video, canvas, sentence, currentTime, triggerNext) {
  ...
  setTimeout(draw, fps, video, canvas, sentence, currentTime, triggerNext);
}
...
class Render extends Component {
  ...
  handlePlay() {
    ...
    draw(video, canvas, this.state.sentence, 0, this.triggerNext)
  }

  triggerNext() {

    if (this.state.index < testURLS.length - 1) {
